...
const Footer = () => {
  return (
    <footer
      className="wow fadeInUp relative z-10 bg-[#1C7DD9] pt-20 lg:pt-[100px]"
      data-wow-delay=".15s"
    >
            ...
            <div className="mb-10 w-full">
              ...
              <ul>
                <li>
                  <a
                    href="/#"
                    className="mb-3 inline-block text-base text-gray-7 hover:text-[#1C7DD9]"
                  >
                    Home
                  </a>
                </li>
