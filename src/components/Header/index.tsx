              ...
              >
                {pathUrl !== "/" ? (
                  <>
                    ...
                    />
                    <Image
                      src={`/images/logo/logonew-white.svg`}
                      alt="logo"
                      width={240}
                      height={30}
                  ...
                  <>
                    <Image
                      src={`${
                        sticky
                          ? "/images/logo/logonew.svg"
                          : "/images/logo/logonew-white.svg"
                      }`}
                      alt="logo"
                      width={140}
                      height={30}
            ...
            <div className="flex w-full items-center justify-between px-4">
              <div>
                <button
                  ...
                  className="absolute right-4 top-1/2 block -translate-y-1/2 rounded-lg px-3 py-[6px] ring-[#1C7DD9] focus:ring-2 lg:hidden"
                >
                  <span
                        ...
                        <li key={index} className="group relative">
                          {pathUrl !== "/" ? (
                            <Link
                              ...
                              scroll={false}
                              href={menuItem.path}
                              className={`ud-menu-scroll flex py-2 text-base text-dark group-hover:text-[#1C7DD9] dark:text-white dark:group-hover:text-[#1C7DD9] lg:inline-flex lg:px-0 lg:py-6 ${
                                pathUrl === menuItem?.path && "text-[#1C7DD9]"
                              }`}
                            >
                              {menuItem.title}
                            </Link>
                            ...
                            <Link
                              ...
                              className={`ud-menu-scroll flex py-2 text-base lg:inline-flex lg:px-0 lg:py-6 ${
                                sticky
                                  ? "text-dark group-hover:text-[#1C7DD9] dark:text-white dark:group-hover:text-[#1C7DD9]"
                        ...
                        <li className="submenu-item group relative" key={index}>
                          {pathUrl !== "/" ? (
                            <button
                              ...
                              className={`ud-menu-scroll flex items-center justify-between py-2 text-base text-dark group-hover:text-[#1C7DD9] dark:text-white dark:group-hover:text-[#1C7DD9] lg:inline-flex lg:px-0 lg:py-6`}
                            >
                              {menuItem.title}
                              ...
                              <Link
                                ...
                                className={`block rounded px-4 py-[10px] text-sm ${
                                  pathUrl === submenuItem.path
                                    ? "text-[#1C7DD9]"
                                    : "text-body-color hover:text-[#1C7DD9] dark:text-dark-6 dark:hover:text-[#1C7DD9]"
                                }`}
                              >
                                {submenuItem.title}
                              </Link>
                ...
                {session?.user ? (
                  <>
                    ...
                    {pathUrl !== "/" || sticky ? (
                      <button
                        onClick={() => signOut()}
                        className="signUpBtn rounded-lg bg-[#1C7DD9] bg-opacity-100 px-6 py-3 text-base font-medium text-white duration-300 ease-in-out hover:bg-opacity-20 hover:text-dark"
                      >
                        Sign Out
                      </button>
                    ) : (
                  ...
                  <>
                    {pathUrl !== "/" ? (
                      <>
                        ...
                        <Link
                          href="https://accounts.bargainwale.com/sign-in"
                          className="rounded-lg bg-[#1C7DD9] px-6 py-3 text-base font-medium text-white duration-300 ease-in-out hover:bg-[#1C7DD9]/90 dark:bg-white/10 dark:hover:bg-white/20"
                        >
                          Get Started
                        </Link>
                      </>
