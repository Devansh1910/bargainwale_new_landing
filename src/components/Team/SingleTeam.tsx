...
const SingleTeam = ({ team }: { team: TeamType }) => {
  ...
  return (
    <div className="w-full px-4 sm:w-1/2 lg:w-1/4 xl:w-1/4">
      <div className="group mb-8 h-[325px] rounded-xl bg-white px-5 pb-10 pt-12 shadow-testimonial dark:bg-dark dark:shadow-none">
          ...
          <div className="flex items-center justify-center gap-5">
            {linkedinLink && (
              <Link
                ...
                href={linkedinLink}
                target="_blank"
                className="text-dark-6 hover:text-[#1C7DD9]"
              >
            ...
            {facebookLink && (
              <Link
                ...
                className="text-dark-6 hover:text-[#1C7DD9]"
              >
                <FaFacebookSquare className="text-l" />
              </Link>
            )}
            {twitterLink && (
              <Link
