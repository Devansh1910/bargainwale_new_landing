    ...
    <section className="relative z-20 overflow-hidden bg-white pb-8 pt-20 dark:bg-dark lg:pb-[50px] lg:pt-[120px]">
      <div className="container">
        <SectionTitle
          ...
          paragraph="We understand you might have queries about Bargainwale. Here are the most common questions answered for your convenience."
          width="640px"
          center
        />
        ...
        <div className="-mx-4 mt-[60px] flex flex-wrap lg:mt-20">
          <div className="w-full px-4 lg:w-1/2">
            <SingleFaq
              question="How to use Bargainwale?"
              answer="Bargainwale simplifies transactions and order management for manufacturers, traders, and sellers. Set up your account, upload your products, and start managing orders seamlessly within minutes."
            />
            <SingleFaq
              question="Is Bargainwale suitable for small businesses?"
              answer="Absolutely! Bargainwale is designed to cater to businesses of all sizes, offering scalable solutions that adapt to your growing needs."
            />
            <SingleFaq
              question="How secure is my data on Bargainwale?"
              answer="Your data security is our priority. Bargainwale uses advanced encryption protocols and secure cloud storage to ensure your information is safe and accessible only to you."
            />
          </div>

          <div className="w-full px-4 lg:w-1/2">
            <SingleFaq
              question="Can I integrate Bargainwale with other tools?"
              answer="Yes, Bargainwale supports integrations with popular tools and platforms like accounting software, inventory systems, and more. Contact our support team for detailed guidance."
            />
            <SingleFaq
              question="Is there a free trial available?"
              answer="Yes, we offer a 14-day free trial so you can explore all the features of Bargainwale before committing to a plan.."
            />
            <SingleFaq
              question="How do I get customer support?"
              answer="You can reach out to our dedicated support team via email, chat, or phone. We’re here to help you 24/7."
            />
          </div>
        </div>
      </div>
